...
4. Use the upload area to import one file at a time for the selected account.
...
7. Use the bulk controls above the table when you want to apply one account, confirm several transactions, or delete several transactions at once.
