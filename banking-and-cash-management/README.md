...
Import bank activity, review likely duplicates before rows enter pending review, confirm transactions when they are ready, and create rules for repeated patterns.
