...
6. Open `Defaults` from the left sidebar when you want to store tenant-level defaults for future companies or bulk-apply required-account-field and edit-policy defaults to selected active companies.
