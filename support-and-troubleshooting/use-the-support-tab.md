...
Open the Support tab to download a troubleshooting log, clear the current session log, review contact options, check for updates when your app supports them, and open support resources.
