...
6. If your installed app exposes update controls, review the visible update actions first:
   ...
   - Depending on updater state, `Release Notes` may show installed, downloaded, or latest public release details.
...
You can reach the product's visible support actions from one tab and leave with the log file, contact method, update action, release-note reference, bug-reporting path, or help topic you need.
...
- [Frequently asked questions](../faq-and-glossary/frequently-asked-questions.md)
